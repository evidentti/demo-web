...
angular.module("demoWebApp", ['ui.router', 'app.service', 'app.controllers', 'app.routes', 'data.directive',
	'competition.directive', 'set.variable.rule.operation.directive', 'operand.directive', 'ngMaterial', 'ngMdIcons', 'ngMessages'])
